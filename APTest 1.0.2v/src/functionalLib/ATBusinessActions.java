...
//xsSelectafter.selectByValue(itemValues.getText() );
	...
	*/
	 ...
	 * Tax Calculation 
	 * Created by GRK 
	 * Usage: A generic function for Posting the taxed amount to the amount fields
	 */
	public void WithTax(String strLocator, String trgLocator) {
		try {
			...
			String taxedValue = getElement(strLocator).getText();
			selectReport.ReportStep("Fail", "Updation of the taxed Value Failed", "With tax", taxedValue);

		}

	}
	
	public void selectPayment(String strLocator, String Arwlocator1, String Arwlocator2, String value) {

		try {

		List<WebElement> Payments = BDriver.findElements(By.xpath(strLocator));
		...
		for (int i = 0; i <size; i++) {
			try {
			while(i>15) {
				scrollToEle(lastElement,"Last Element");
				break;
			}
			} 
			catch (Exception e) {
				//System.out.println("Table size is lessthan 15");
			}
			
		eleValue = Payments.get(i).getText();
		System.out.println(eleValue);
		if (eleValue.equalsIgnoreCase(value)) {
			...
			selectReport.ReportStep("Pass", "Select Payments", "Clicked on", value);
			break;
			}
	...
	//Usage: A generic function for Selecting installments
	public void selectInstallments(String strLocator, String Arwlocator1, String Arwlocator2, String value)
		{
			WebDriverWait wait = new WebDriverWait(BDriver, 50);
			try {
				 ...
				 for(int i=0;i<size;i++){ 
					 //Thread.sleep(3000);
					 System.out.println("For loop strat");
					 ...
					 if (!eleValue.equalsIgnoreCase(value)) {
						 //Payments.get(i).click();
						 String arrow=Arwlocator1+1+Arwlocator2;
						 System.out.println(arrow);
						 BDriver.findElement(By.xpath(arrow)).click();
						 System.out.println("row selected");
						 controlClick(oUIObj.DeleteInstall_xp, "Delete Installments");
						 controlClick(oUIObj.DeleteOK_xp, "Delete Ok");
						 continue;
					 }
					...
					{	
				System.err.println("Installment selection done" + e.getMessage());
				}
		    }	
	//Usage: A generic function for Deleting installments
	public void deleteInstallments(String strLocator, String Arwlocator1, String Arwlocator2, String value)
		{
...
//			waitforpageload();
	...
	//Payments
	public void Paymentworkbench() throws Exception {
		pImplicitWait();
		ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "WirePay");
		System.out.println("ATTestSC sheet read");
		controlClick(oUIObj.home_id, "Home");
		controlClick(oUIObj.PayablesIcon_xp, "Payables");
		controlClick(oUIObj.PaymentIcon_xp, "Payments");
		controlClick(oUIObj.TaskBar_xp, "Taskbar");
		//selectPayment(oUIObj.paymentName, oUIObj.arrowp1, oUIObj.arrowp2 ,"Autowire-3.3");
		//selectInstallments(oUIObj.InstallInvNum_xp, oUIObj.Linepart1_xp, oUIObj.Linepart2 ,"Autopaywire-3.5");
	}

	
	//Create Positive pay file for check payments
		public void PositivePay() throws Exception
		{
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "PositivePay");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.PositivePay_xp, "Positive Pay");
			setText(oUIObj.PayProcessProfile_xp,oExcelLogin.getCellData("Payment Process Profile", 1));
			BDriver.findElement(By.xpath(oUIObj.PayProcessProfile_xp)).sendKeys(Keys.ARROW_DOWN);
			controlClick(oUIObj.SubmitPP_xp, "Submit");
			controlClick(oUIObj.OKPP_xp, "OK");
			controlClick(oUIObj.home_id, "Home");
			//controlClick(oUIObj.Error_xp, "Catch Error");
			controlClick(oUIObj.Tools_xp, "Tools");
			controlClick(oUIObj.SP_xp, "Schedule Process");
			for(int i=0;i<7;i++)
			{
				Thread.sleep(2000);
			    controlClick(oUIObj.SPRefresh_xp, "Refresh");
			}
			controlClick(oUIObj.SPOutput_xp, "View Output");
		...
		public void PaymentRegister() throws InterruptedException
		{
			//select report
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "PayablesPaymentRegister");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.home_id, "Home");
			controlClick(oUIObj.Tools_xp, "Tools");
			controlClick(oUIObj.SP_xp, "Schedule Process");
			controlClick(oUIObj.SchNewProcess_xp, "Schedule New Process");
			controlClick(oUIObj.Namedropdown_xp, "Name Dropdown");
			controlClick(oUIObj.SPSearch_xp, "Search");
			setText(oUIObj.SPName_xp, oExcelLogin.getCellData("Name", 1));
			controlClick(oUIObj.SPSearch1_xp, "Search");
			controlClick(oUIObj.SelectRow_xp, "Select Row");
			controlClick(oUIObj.SPOK_xp, "OK");
			controlClick(oUIObj.SPOK1_xp, "OK");
			setText(oUIObj.PRBU_xp, oExcelLogin.getCellData("Business Unit", 1));
			controlClick(oUIObj.PRBUContext_xp, "Business Unit Context ");
			DropdownSelection(oUIObj.PRBUContext_xp, oExcelLogin.getCellData("Business Unit Context ", 1));
			setText(oUIObj.PRFromDate_xp, oExcelLogin.getCellData("From Date", 1));
			setText(oUIObj.PRToDate_xp, oExcelLogin.getCellData("To Date", 1));
			controlClick(oUIObj.PRDisPayAdd_xp, "Payee Address");
			DropdownSelection(oUIObj.PRDisPayAdd_xp, oExcelLogin.getCellData("Display Payee Address ", 1));
			//BDriver.findElement(By.xpath(oUIObj.PRBUContext_xp)).sendKeys(Keys.ARROW_DOWN);
			//setText(oUIObj.PRPayTyp_xp, oExcelLogin.getCellData("Payment Type", 1));
			controlClick(oUIObj.Submit_xp, "SUBMIT");
			controlClick(oUIObj.SPOk_xp, "OK");
			for(int i=0;i<7;i++)
			{
			...
			controlClick(oUIObj.SPOutput_xp, "Output");
			
		}
		
		//Payables Invoice Register
			public void InvoiceRegister() throws InterruptedException
			{
				//select report
				pImplicitWait();
				ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "PayablesInvoiceRegister");
				System.out.println("ATTestSC sheet read");
				controlClick(oUIObj.home_id, "Home");
				controlClick(oUIObj.Tools_xp, "Tools");
				controlClick(oUIObj.SP_xp, "Schedule Process");
				...
				controlClick(oUIObj.SPOK1_xp, "OK");
				setText(oUIObj.PRBU_xp, oExcelLogin.getCellData("Business Unit", 1));
				setText(oUIObj.PRSupplier_xp, oExcelLogin.getCellData("Supplier", 1));
				controlClick(oUIObj.PRInType_xp, "Invoice Type");
				DropdownSelection(oUIObj.PRInType_xp, oExcelLogin.getCellData("Invoice Type ", 1));
				setText(oUIObj.FromEnterDate_xp, oExcelLogin.getCellData("From Entered Date", 1));
				setText(oUIObj.ToEnterDate, oExcelLogin.getCellData("To Entered Date ", 1));
				setText(oUIObj.PRAccPeriod_xp, oExcelLogin.getCellData("Accounting Period ", 1));
				controlClick(oUIObj.CanInvOnly_xp, "Canceled Invoices Only");
				DropdownSelection(oUIObj.CanInvOnly_xp, oExcelLogin.getCellData("Canceled Invoices Only", 1));
				controlClick(oUIObj.UnvalInvOnly_xp, "Unvalidated Invoices Only");
				DropdownSelection(oUIObj.UnvalInvOnly_xp, oExcelLogin.getCellData("Unvalidated Invoices Only ", 1));
				controlClick(oUIObj.Submit_xp, "SUBMIT");
				controlClick(oUIObj.SPOk_xp, "OK");
				for(int i=0;i<7;i++)
				{
		...
		//Separate Remittance
		public void CreateSeperateRemittance()
		{
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "Accounting");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.SepRemAdv_xp, "Send Separate Remittance advice");
			setText(oUIObj.PayFile_xp, oExcelLogin.getCellData("Payment File	", 1));
			setText(oUIObj.Format_xp, oExcelLogin.getCellData("Format	", 1));
			setText(oUIObj.PayRefForm_xp, oExcelLogin.getCellData("Payment Reference From", 1));
			setText(oUIObj.PayRefTo_xp, oExcelLogin.getCellData("Payment Reference To", 1));
			controlClick(oUIObj.SubmitPP_xp, "SUBMIT");
			
		}
		
		//Pre-Payment Prepayment Invoice, Full Pay and application to Invoice
		public void PrePayment() throws Exception
		{
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "PrePayment");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.create_xp, "Create");
			setText(oUIObj.BU_xp, oExcelLogin.getCellData("Business Unit", 1));
			controlClick(oUIObj.SupplierSearch1_xp, "SupplierSearch");
			...
			selectFromAutosearch(oUIObj.SuppSelect1_xp,oExcelLogin.getCellData("Supplier", 1));
			controlClick(oUIObj.Suppok_xp, "Supplierok");
			setText(oUIObj.Number_xp, oExcelLogin.getCellData("Numberpre", 1));
			setText(oUIObj.Amount_xp, oExcelLogin.getCellData("Amountpre", 1));
	   		controlClick(oUIObj.Type_xp, "Type");
			SelectValueFromDropdown(oUIObj.Type_xp, "PrePayment");
			controlClick(oUIObj.PrePayment, "PrePayment");
			setText(oUIObj.Requester_xp, oExcelLogin.getCellData("Requester Name", 1));
			BDriver.findElement(By.xpath(oUIObj.Requester_xp)).sendKeys(Keys.ARROW_DOWN);
			controlClick(oUIObj.Lines_xp, "Linestilt");
			setText(oUIObj.Lineamount_xp, oExcelLogin.getCellData("Line Amountpre", 1));
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			Thread.sleep(3000);
			controlClick(oUIObj.Calculatetax_xp, "Calculate Tax");
			WithTax(oUIObj.Calculatetax1_xp,oUIObj.Amount_xp);
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Validate_xp, "Validate");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Approval_xp, "Approval");
			controlClick(oUIObj.ForAppr_xp, "Forced Approval");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.PayInFull_xp, "Pay in Full");
			setText(oUIObj.PPP_xp, oExcelLogin.getCellData("Payment Process Profile ", 1));
			controlClick(oUIObj.SubmitPrePay_xp, "Submit");
			controlClick(oUIObj.pop_xp, "OK");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.PostLedger_xp, "Post To Ledger");
			controlClick(oUIObj.AccOK_xp, "OK");
			controlClick(oUIObj.home_id, "Home");
			controlClick(oUIObj.PayablesIcon_xp, "Payables");
			controlClick(oUIObj.Invoices_xp, "Invoice");
			controlClick(oUIObj.TaskBar_xp, "Taskbar");
			controlClick(oUIObj.create_xp, "Create");
			setText(oUIObj.BU_xp, oExcelLogin.getCellData("Business Unit", 1));
			controlClick(oUIObj.SupplierSearch1_xp, "SupplierSearch");
			...
			setText(oUIObj.Lineamount_xp, oExcelLogin.getCellData("Line Amount", 1));
			controlClick(oUIObj.DistributionCombination_xp, "Click Distribution Combination");
			//setText(oUIObj.DistributionCombination_xp, oExcelLogin.getCellData("Distribution Combination", 1));
			BDriver.findElement(By.xpath(oUIObj.DistributionCombination_xp)).sendKeys(Keys.TAB);
			controlClick(oUIObj.Linedistributioncomb_xp, "Linedistribution");
			controlClick(oUIObj.Account_xp, "Account");
			controlClick(oUIObj.Accountdd_xp, "Accountdd");
			...
			controlClick(oUIObj.Selectok_xp, "Ok");	
			//controlClick(oUIObj.Invoiceactions_xp, "Invoice Actions");
			//controlClick(oUIObj.Refresh_xp, "Refresh");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Calculatetax_xp, "Calculate Tax");
			WithTax(oUIObj.Calculatetax1_xp,oUIObj.Amount_xp);
			
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.ApplyPre_xp, "Apply");
			selectFromList(oUIObj.SelectLinePre_xp,oExcelLogin.getCellData("Numberpre", 1));
			Thread.sleep(5000);
			controlClick(oUIObj.Apply1_xp, "Apply Prepayment");
			Thread.sleep(5000);
			controlClick(oUIObj.Done_xp, "Done");
			Thread.sleep(3000);
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Validate_xp, "Validate");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
		...
		{
			controlClick(oUIObj.Invoiceactions_xp, "Invoice Actions");
			controlClick(oUIObj.Calculatetax_xp, "Invoice Actions");
			WithTax(oUIObj.Calculatetax1_xp,oUIObj.Amount_xp);
			controlClick(oUIObj.Save_xp, "Save");
			controlClick(oUIObj.Invoiceactions_xp, "Invoice Actions");
			controlClick(oUIObj.Validate_xp, "Validate");
			controlClick(oUIObj.Invoiceactions_xp, "Invoice Actions");
			controlClick(oUIObj.Approval_xp, "Approval");
			controlClick(oUIObj.ForceApproval_xp, "Forced Approval");
			
		}
		
		public void ExternalPay() throws InterruptedException
		{
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "ExternalPay");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.create_xp, "Create");
			setText(oUIObj.BU_xp, oExcelLogin.getCellData("Business Unit", 1));
			controlClick(oUIObj.SupplierSearch1_xp, "SupplierSearch");
			...
			selectFromAutosearch(oUIObj.SuppSelect1_xp,oExcelLogin.getCellData("Supplier", 1));
			controlClick(oUIObj.Suppok_xp, "Supplierok");
			setText(oUIObj.Invoicegroup_xp, oExcelLogin.getCellData("Invoice Group", 1));
			setText(oUIObj.Number_xp, oExcelLogin.getCellData("Number", 1));
			setText(oUIObj.Amount_xp, oExcelLogin.getCellData("Amount", 1));
			setText(oUIObj.Requester_xp, oExcelLogin.getCellData("Requester Name", 1));
			BDriver.findElement(By.xpath(oUIObj.Requester_xp)).sendKeys(Keys.ARROW_DOWN);
			setText(oUIObj.Payment_xp, oExcelLogin.getCellData("Payment Terms", 1));
			controlClick(oUIObj.Lines_xp, "Linestilt");
			setText(oUIObj.Lineamount_xp, oExcelLogin.getCellData("Line Amount", 1));
			controlClick(oUIObj.DistributionCombination_xp, "Click Distribution Combination");
			//setText(oUIObj.DistributionCombination_xp, oExcelLogin.getCellData("Distribution Combination", 1));
			...
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Manageinstallments_xp, "Manage Installments");
			setText(oUIObj.PayMeth1_xp, oExcelLogin.getCellData("Payment Method", 1));
			//controlClick(oUIObj.SelLine_xp, "Select Line");
			//controlClick(oUIObj.SplitInstall_xp, "Split Installments");
			//controlClick(oUIObj.SAC_xp, "Save and close");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Validate_xp, "Validate");
			controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			controlClick(oUIObj.Approval_xp, "Approval");
			...
			controlClick(oUIObj.PaymentIcon_xp, "Payments");
			controlClick(oUIObj.TaskBar_xp, "Taskbar");
			controlClick(oUIObj.SubmitPPR_xp, "Submit PPR");
			setText(oUIObj.Name_xp, oExcelLogin.getCellData("Name", 1));
			setText(oUIObj.Template_xp, oExcelLogin.getCellData("Template", 1));
			controlClick(oUIObj.PayThroughDate_xp, "Pay Through Date");
			setText(oUIObj.InvGrp_xp, oExcelLogin.getCellData("Invoice Group", 1));
			setText(oUIObj.PayMeth_xp, oExcelLogin.getCellData("Payment Method", 1));
			
			
			//setText(oUIObj.SupplierParty_xp, oExcelLogin.getCellData("Supplier",1));
			 
			  controlClick(oUIObj.Sub_xp,"Submit");
			  for(int i=0;i<7;i++)
			    {
				  Thread.sleep(3000);
			        controlClick(oUIObj.PPRRefresh_xp,"Refresh PPR");
			    }
			  selectPayment(oUIObj.paymentName, oUIObj.arrowp1, oUIObj.arrowp2 ,oExcelLogin.getCellData("Name", 1));
			  //selectInstallments(oUIObj.InstallInvNum_xp, oUIObj.Linepart1_xp, oUIObj.Linepart2 , oExcelLogin.getCellData("Number", 1));
			  controlClick(oUIObj.SubmitPay_xp, "Submit Payment");
			  for(int i=0;i<7;i++)
			   {
				  Thread.sleep(3000);
			       controlClick(oUIObj.PPRRefresh_xp, "Refresh");
			   }
			  selectPayment(oUIObj.paymentName, oUIObj.arrowp1, oUIObj.arrowp2 ,oExcelLogin.getCellData("Name", 1));
			  controlClick(oUIObj.ResumePay_xp, "Resume Payment");
			  //controlClick(oUIObj.RecCom_xp, "Recently Completed");
			  for(int i=0;i<7;i++)
			   {
				  Thread.sleep(3000);
			       controlClick(oUIObj.PPRRefresh_xp, "Refresh");
		...
		public void WirePay() throws InterruptedException
		{
			  ...
			  BDriver.findElement(By.xpath(oUIObj.Requester_xp)).sendKeys(Keys.ARROW_DOWN);
			  setText(oUIObj.Payment_xp, oExcelLogin.getCellData("Payment Terms", 1));
			  controlClick(oUIObj.Lines_xp, "Linestilt"); setText(oUIObj.Lineamount_xp,
			  oExcelLogin.getCellData("Line Amount", 1));
			  controlClick(oUIObj.DistributionCombination_xp, "Click Distribution Combination");
			  //setText(oUIObj.DistributionCombination_xp, oExcelLogin.getCellData("Distribution Combination", 1));
			  BDriver.findElement(By.xpath(oUIObj.DistributionCombination_xp)).sendKeys(Keys.TAB);
			  controlClick(oUIObj.Linedistributioncomb_xp, "Linedistribution");
			  controlClick(oUIObj.Account_xp, "Account"); controlClick(oUIObj.Accountdd_xp,"Accountdd");
			  selectFromAutosearch(oUIObj.Acclist_xp,oExcelLogin.getCellData("Account", 1)); 
			  controlClick(oUIObj.Selectok_xp, "Ok");
			  controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			  controlClick(oUIObj.Calculatetax_xp, "Calculate Tax");
			  ...
			  controlClick(oUIObj.PaymentIcon_xp, "Payments");
			  controlClick(oUIObj.TaskBar_xp, "Taskbar");
			  controlClick(oUIObj.PayProReq_xp, "Submit PPR");
			  setText(oUIObj.Name_xp, oExcelLogin.getCellData("Name", 1));
			  setText(oUIObj.Template_xp, oExcelLogin.getCellData("Template", 1));
			  controlClick(oUIObj.PayThroughDate_xp, "Pay Through Date");
			  setText(oUIObj.InvGrp_xp, oExcelLogin.getCellData("Invoice Group", 1));
		...
		public void InHousePay() throws InterruptedException
		{
			 pImplicitWait(); 
			  ExcelRead oExcelLogin = new ExcelRead(sTDFileName,"InhousePay"); 
			  System.out.println("ATTestSC sheet read");
			  controlClick(oUIObj.create_xp, "Create");
			  setText(oUIObj.BU_xp,oExcelLogin.getCellData("Business Unit", 1));
			  controlClick(oUIObj.SupplierSearch1_xp, "SupplierSearch");
		...
		public void ACHPay() throws InterruptedException
		{
			
			  pImplicitWait(); 
			  ExcelRead oExcelLogin = new ExcelRead(sTDFileName,"ACH"); 
			  System.out.println("ATTestSC sheet read");
			  controlClick(oUIObj.create_xp, "Create");
			  setText(oUIObj.BU_xp,oExcelLogin.getCellData("Business Unit", 1));
			  controlClick(oUIObj.SupplierSearch1_xp, "SupplierSearch");
			  ...
			  setText(oUIObj.InvGrp_xp, oExcelLogin.getCellData("Invoice Group", 1));
			  setText(oUIObj.PayMeth_xp, oExcelLogin.getCellData("Payment Method", 1));
			  //ErrorValidation(oUIObj.InvGrp_xp,"Invoice Group Missing");
			  //setText(oUIObj.SupplierParty_xp, oExcelLogin.getCellData("Supplier",1));
			  controlClick(oUIObj.Sub_xp,"Submit");
			  for(int i=0;i<7;i++)
			    {
		...
		public void OutSourcedCheckPay() throws InterruptedException
		{
			
			  pImplicitWait(); 
			  ExcelRead oExcelLogin = new ExcelRead(sTDFileName,"OutSourcedPay"); 
			  System.out.println("ATTestSC sheet read");
			  controlClick(oUIObj.create_xp, "Create");
			  setText(oUIObj.BU_xp,oExcelLogin.getCellData("Business Unit", 1));
			  controlClick(oUIObj.SupplierSearch1_xp, "SupplierSearch");
			  ...
			  controlClick(oUIObj.Manageinstallments_xp, "Manage Installments");
			  setText(oUIObj.PayMeth1_xp, oExcelLogin.getCellData("Payment Method", 1));
			  //controlClick(oUIObj.SelectLine_xp, "Select Line");
			  //controlClick(oUIObj.SplitInstall_xp, "Split Installment");
			  controlClick(oUIObj.SAC_xp, "Save and close");
			  controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
			  controlClick(oUIObj.Validate_xp, "Validate");
			  controlClick(oUIObj.InvoiceActionsx_xp, "Invoice Actions");
		...
		public void CreateAccounting() throws InterruptedException
		{
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "CreateAccounting");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.CreateAccount_xp,"Create Accounting"); 
			controlClick(oUIObj.Subledger_xp, "Subledger Application");
			DropdownSelection(oUIObj.Subledger_xp, oExcelLogin.getCellData("Subledger Application ", 1));
			setText(oUIObj.Ledger_xp, oExcelLogin.getCellData("Ledger ", 1));
			setText(oUIObj.EndDate_xp, oExcelLogin.getCellData("End Date ", 1));
			controlClick(oUIObj.AccountingMode_xp, "Accounting Mode");
			DropdownSelection(oUIObj.AccountingMode_xp, oExcelLogin.getCellData("Accounting Mode", 1));
			controlClick(oUIObj.ProcessEvents_xp, "Process Events");
			DropdownSelection(oUIObj.ProcessEvents_xp, oExcelLogin.getCellData("Process Events ", 1));
			controlClick(oUIObj.ReportStyle_xp, "Report Style");
			DropdownSelection(oUIObj.ReportStyle_xp, oExcelLogin.getCellData("Report Style ", 1));
			controlClick(oUIObj.TraGenLed_xp, "Transfer to General Ledger");
			DropdownSelection(oUIObj.TraGenLed_xp, oExcelLogin.getCellData("Transfer to General Ledger ", 1));
			controlClick(oUIObj.PostGenLed_xp, "Post in General Ledger");
			DropdownSelection(oUIObj.PostGenLed_xp, oExcelLogin.getCellData("Post in General Ledger ", 1));
			controlClick(oUIObj.IncUTraIden_xp, "Include User Transaction Identifiers");
			DropdownSelection(oUIObj.IncUTraIden_xp, oExcelLogin.getCellData("Include User Transaction Identifiers ", 1));
			controlClick(oUIObj.SubmitAcc_xp,"Submit Accounting"); 	
			controlClick(oUIObj.SPOk_xp, "OK");
			controlClick(oUIObj.home_id, "Home");
			controlClick(oUIObj.Tools_xp, "Tools");
			controlClick(oUIObj.SP_xp, "Schedule Process");
			...
			controlClick(oUIObj.Namedropdown_xp, "Name Dropdown");
			controlClick(oUIObj.SPSearch_xp, "Search");
			setText(oUIObj.SPName_xp,oExcelLogin.getCellData("PPCName", 1));
			controlClick(oUIObj.SPSearch1_xp, "Search");
			controlClick(oUIObj.SelectRow_xp, "Select Row");
			controlClick(oUIObj.SPOK_xp, "OK");
			controlClick(oUIObj.SPOK1_xp, "OK");
			setText(oUIObj.SPLedger_xp,oExcelLogin.getCellData("Ledger ", 1));
			setText(oUIObj.SPFromAccDate_xp,oExcelLogin.getCellData("PPCFrom Accounting Date ", 1));
			setText(oUIObj.SPToAccDate_xp,oExcelLogin.getCellData("PPCTo Accounting Date ", 1));
			controlClick(oUIObj.Submit_xp, "SUBMIT");
			controlClick(oUIObj.SPOk_xp, "OK");
			for(int i=0;i<7;i++)
			{
			...
			controlClick(oUIObj.SPOK_xp, "OK");
			controlClick(oUIObj.SPOK1_xp, "OK");
			controlClick(oUIObj.SWReportLevel, "Report Level");
			//DropdownSelection(oUIObj.SWReportLevel, oExcelLogin.getCellData("Report Level ", 1));
			//controlClick(oUIObj.SWBU_xp, "Business unit");
			setText(oUIObj.SWReportContext, oExcelLogin.getCellData("Report Context ", 1));
			setText(oUIObj.FromAccountingDate, oExcelLogin.getCellData("From Accounting Date ", 1));
			setText(oUIObj.ToAccountingDate_xp, oExcelLogin.getCellData("To Accounting Date ", 1));
			SelectValueFromDropdown(oUIObj.Period_xp, oExcelLogin.getCellData("Period ", 1));
			setText(oUIObj.Period_xp, oExcelLogin.getCellData("Period ", 1));
			controlClick(oUIObj.Period_xp, "Period");
			//setText(oUIObj.SweepNow_xp, oExcelLogin.getCellData("Sweep Now", 1));
		    //setText(oUIObj.SweepPeriod_xp, oExcelLogin.getCellData("Sweep Period", 1));
			...
			controlClick(oUIObj.Invoices_xp, "Invoice");
			controlClick(oUIObj.TaskBar_xp, "Taskbar");
			controlClick(oUIObj.ManageAcc1_xp, "Manage Accounting Periods");
			controlClick(oUIObj.LineSelect1_xp, "Line Select");
			controlClick(oUIObj.Actions_xp, "Click on Actions");
			controlClick(oUIObj.CloseCurrPer_xp, "Close Current Period");
			controlClick(oUIObj.SelectBU_xp, "Select BU");
			for(int i=0;i<7;i++)
			{
				Thread.sleep(2000);
				controlClick(oUIObj.RefreshPeriod_xp, "Refresh");
			}
			controlClick(oUIObj.home_id, "Home");
			controlClick(oUIObj.Tools_xp, "Tools");
			controlClick(oUIObj.SP_xp, "Schedule Process");
			ErrorValidation(oUIObj.SPOutputError_xp,"Failed");
			controlClick(oUIObj.SPOutput_xp, "Succeeded");
			...
			controlClick(oUIObj.SPOK_xp, "OK");
			controlClick(oUIObj.SPOK1_xp, "OK");
			setText(oUIObj.ReqNam_xp, oExcelLogin.getCellData("Request Name", 1));
			setText(oUIObj.AGLedger_xp, oExcelLogin.getCellData("Ledger ", 1));
			BDriver.findElement(By.xpath(oUIObj.AGLedger_xp)).sendKeys(Keys.ARROW_DOWN);
			setText(oUIObj.AGBU_xp, oExcelLogin.getCellData("Business Unit ", 1));
			setText(oUIObj.AGAccPeriod_xp,oExcelLogin.getCellData("Accounting Period", 1));
			controlClick(oUIObj.Submit_xp, "SUBMIT");
			controlClick(oUIObj.SPOk_xp, "OK");
			for(int i=0;i<7;i++)
			{
			...
			// View Prepare Payables to General Ledger Reconciliation
		    controlClick(oUIObj.SP_xp, "Schedule Process");
			controlClick(oUIObj.SchNewProcess_xp, "Schedule New Process");
			controlClick(oUIObj.Namedropdown_xp, "Name Dropdown");
			controlClick(oUIObj.SPSearch_xp, "Search");
		...
		public void PCPSubLedger() throws InterruptedException
		{
			pImplicitWait();
			ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "SubLedger");
			System.out.println("ATTestSC sheet read");
			controlClick(oUIObj.home_id, "Home");
			controlClick(oUIObj.Tools_xp, "Tools");
			controlClick(oUIObj.SP_xp, "Schedule Process");
			...
			controlClick(oUIObj.SPOK_xp, "OK");
			controlClick(oUIObj.SPOK1_xp, "OK");
			//setText(oUIObj.JournalSource_xp, oExcelLogin.getCellData("Ledger", 1));
			setText(oUIObj.PCPLedger_xp, oExcelLogin.getCellData("Ledger ", 1));
			setText(oUIObj.PCPFromAccPeriod_xp, oExcelLogin.getCellData("From Accounting Period", 1));
			setText(oUIObj.SPToAccDate_xp, oExcelLogin.getCellData("To Accounting Period ", 1));
			controlClick(oUIObj.Submit_xp, "SUBMIT");
			controlClick(oUIObj.SPOk_xp, "OK");
			for(int i=0;i<7;i++)
			{
		 ...
		 // Period Close Sweep Process
		 public void PCPSweepProcess() throws InterruptedException
		 {
			    pImplicitWait();
			    ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "SweepProcess");
				System.out.println("ATTestSC sheet read");
			    controlClick(oUIObj.home_id, "Home");
				controlClick(oUIObj.Tools_xp, "Tools");
				controlClick(oUIObj.SP_xp, "Schedule Process");
				...
				setText(oUIObj.ToAccountingDate_xp, oExcelLogin.getCellData("To Accounting Date ", 1));
				controlClick(oUIObj.Period_xp, "Period");
				DropdownSelection(oUIObj.Period_xp, oExcelLogin.getCellData("Period ", 1));
				//setText(oUIObj.SweepNow_xp, oExcelLogin.getCellData("Sweep Now", 1));
			    //setText(oUIObj.SweepPeriod_xp, oExcelLogin.getCellData("Sweep Period", 1));
				controlClick(oUIObj.Submit_xp, "SUBMIT");
				controlClick(oUIObj.SPOk_xp, "OK");
		 ...
		 //Period close Process -  Close the payables period
		 public void PCPClosePayablesPeriod() throws InterruptedException
		 {
			    //scrollToEle(oUIObj.ManageAcc1_xp,"View"); 
			    //ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "CloseCurrentPeriod");
				//System.out.println("ATTestSC sheet read");
				controlClick(oUIObj.ManageAcc1_xp, "Manage Accounting Periods");
				controlClick(oUIObj.LineSelect1_xp, "Line Select");
				controlClick(oUIObj.Actions_xp, "Click on Actions");
	     ...
	     //Period close Process - US 1099 Supplier Exceptions Report
		 public void PCPSupplierExceptionReport() throws InterruptedException
		 {
			    pImplicitWait(); 
				ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "SupplierExceptionReport");
				System.out.println("ATTestSC sheet read");
				controlClick(oUIObj.home_id, "Home");
				controlClick(oUIObj.Tools_xp, "Tools");
				controlClick(oUIObj.SP_xp, "Schedule Process");
				...
				controlClick(oUIObj.SPSearch1_xp, "Search");
				controlClick(oUIObj.SelectRow_xp, "Select Row");
				//selectFromAutosearch(oUIObj.SuppSelect1_xp,oExcelLogin.getCellData("Name", 1));
				controlClick(oUIObj.SPOK_xp, "OK");
				controlClick(oUIObj.SPOK1_xp, "OK");
				setText(oUIObj.PRBU_xp, oExcelLogin.getCellData("Business Unit ", 1));
				setText(oUIObj.TaxRepEnt_xp, oExcelLogin.getCellData("Tax Reporting Entity", 1));
				setText(oUIObj.PRFromDate_xp, oExcelLogin.getCellData("From Accounting Date ", 1));
				controlClick(oUIObj.Submit_xp, "SUBMIT");
				controlClick(oUIObj.SPOk_xp, "OK");
				for(int i=0;i<7;i++)
				{
		 ...
		 public void PCPAPGLReconProcess() throws InterruptedException
		 {
			    pImplicitWait(); 
				ExcelRead oExcelLogin = new ExcelRead(sTDFileName, "APGLRecon");
				System.out.println("ATTestSC sheet read");
				controlClick(oUIObj.home_id, "Home");
				controlClick(oUIObj.Tools_xp, "Tools");
				controlClick(oUIObj.SP_xp, "Schedule Process");
		 ...
		 // Period close Process - Open next period
		 public void OpenNextPeriod() throws InterruptedException
		 {
			 pImplicitWait();
			 controlClick(oUIObj.ManageAcc1_xp, "Manage Accounting Periods");
				controlClick(oUIObj.LineSelect1_xp, "Line Select");
				controlClick(oUIObj.Actions_xp, "Click on Actions");
				controlClick(oUIObj.OpenNextPer_xp, "Open Next Period");
				controlClick(oUIObj.SelectBU_xp, "Select BU");
				for(int i=0;i<7;i++)
				{
					Thread.sleep(2000);
